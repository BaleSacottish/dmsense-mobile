...
const PasswordChangePassword = ({ navigation, route }) => {
  const [password, setPassword] = useState('');

  useEffect(() => {
    if (password.length < 6) return;

    navigation.navigate('PasswordChangePasswordConfirm', { ...route.params, password: password })
...
export default PasswordChangePassword